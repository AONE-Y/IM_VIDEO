...
public class VideoChatServer2 {
     ...
     */
    private static ConcurrentHashMap<String, VideoChatServer2> connectedUsers = new ConcurrentHashMap<>();
    /**
    ...
    public void onMessage(String message, Session session) throws Exception {
        ...
        VideoChatServer2 destSocket = connectedUsers.get(destinationUser);
